...
class BooksSearch
{
    ...
    public function getBooks(Request $request)
    {
        ...
        //removing non latin characters to alternative latin characters
        $searchTerm = $this->stripAccents($searchTerm);
    ...
    /**
     * Using this function, not iconv(), because it fails on multi-language  books.
     * @param $str
     * @return mixed
     */
